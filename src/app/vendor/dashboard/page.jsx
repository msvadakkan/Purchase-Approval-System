  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      <Link href="/vendor/tenders"
        className="group flex items-center gap-4 p-5 bg-gradient-to-r from-teal-600 to-teal-500 text-white rounded-2xl hover:from-teal-700 hover:to-teal-600 shadow-md hover:shadow-lg mb-6">
              ...
              <Link key={t.id} href={`/vendor/tenders/${t.id}`}
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-gray-900 truncate group-hover:text-teal-600">{t.title}</p>
                ...
                <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-teal-500 flex-shrink-0 ml-3" />
              </Link>
            ))}
          </div>
        )}
