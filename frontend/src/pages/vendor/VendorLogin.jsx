    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-950 via-teal-800 to-teal-600 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
          ...
          <div className="px-8 py-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                    className="w-full border border-gray-300 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              ...
              <button type="submit" disabled={loading}
                className="w-full bg-teal-600 text-white py-2.5 rounded-xl font-semibold text-sm hover:bg-teal-700 transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              Not registered?{' '}
              <Link to="/vendor/register" className="text-teal-600 font-semibold hover:underline">
        ...
        <p className="text-center text-teal-300 text-xs mt-4">
          <Link to="/login" className="text-white font-medium hover:underline">← Back to staff login</Link>
        </p>
      </div>
    </div>
  );
