...
const field = (label, name, props = {}) => ({ label, name, ...props });
...
export default function NewCompany() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await refresh();
      // Set newly created company as active
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
          ...
          <div className="flex items-center gap-4">
            <div
              ...
              className="w-20 h-20 rounded-2xl border-2 border-dashed border-gray-300 flex items-center justify-center cursor-pointer hover:border-indigo-400 transition-colors overflow-hidden flex-shrink-0 bg-gray-50"
            >
              {preview
