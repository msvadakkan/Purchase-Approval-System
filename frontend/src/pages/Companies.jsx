      ...
      {companies.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-sm text-gray-400 mt-1">
            <Link to="/companies/new" className="text-indigo-600 font-medium hover:underline">Register your first company</Link>
          </p>
        </div>
      ) : (
            ...
            <div key={c.id}
              ...
              <div className="flex gap-2 pt-3 border-t border-gray-50">
                <button
                  ...
                  className="flex-1 py-1.5 text-xs font-semibold rounded-lg border border-indigo-200 text-indigo-600 hover:bg-indigo-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                >
